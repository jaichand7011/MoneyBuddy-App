...
import static drbtechnologies.moneybuddy.moneybuddy.DashboardFragment.task2;
...
public class task1 extends AppCompatActivity {
       ...
       // m.setEnabled(false);
        m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task2.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                onBackPressed();
                return;
    ...
    public void fbAds() {
        ...
        interstitialAd = new InterstitialAd(getApplicationContext(), "133655167502664_133656367502544");
